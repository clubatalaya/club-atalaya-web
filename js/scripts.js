...
function renderVideos(videos){
  ...
  videos.forEach(function(v){
    ...
    a.style.cssText='display:flex;align-items:center;gap:12px;background:#fff;border:1px solid #e0e0e0;border-radius:10px;padding:14px;text-decoration:none;color:#222;box-shadow:0 2px 8px rgba(0,0,0,.06);transition:.2s';
